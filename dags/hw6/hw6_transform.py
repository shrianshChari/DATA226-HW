# This file contains code that completes question 2 of homework 6 for DATA 226
...
with DAG(
    ...
    FROM {database}.raw.user_session_channel u
    JOIN {database}.raw.session_timestamp s ON u.sessionId=s.sessionId
    """
